...
param vnetName string = 'almega-chatbot-vnet'
...
@description('Address prefix for App subnet (inside 10.0.0.0/16)')
param subnetAppPrefix string = '10.0.1.0/24'

@description('Address prefix for Key Vault PE subnet (inside 10.0.0.0/16)')
param subnetKvPrefix string = '10.0.2.0/24'

@description('Address prefix for SQL PE subnet (inside 10.0.0.0/16)')
param subnetSqlPrefix string = '10.0.3.0/24'

@description('Address prefix for Storage PE subnet (inside 10.0.0.0/16)')
param subnetStoragePrefix string = '10.0.4.0/24'

/*
  Notes:
  - We DO NOT touch the existing "default" subnet.
  ...
  - Sequential deployment avoids "AnotherOperationInProgress" conflicts.
*/
